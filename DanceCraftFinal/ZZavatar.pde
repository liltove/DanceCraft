...
//boolean test1 = true;					// booleen pour la surprise
//boolean test2 = true;					// idem
//
...
//  surprise = loadShape("./modeldata/lightsaber.obj");
//
...
//
//  pushMatrix();
//  if (zzKinect.available()) { 	// si la kinect est presente
//    zzKinect.refresh();		// mise a jour de la kinect
//
//    pushMatrix();
//    translate(-zzKinect.getWidth()/2, -zzKinect.getHeight()/2, -800);
//    popMatrix();
//
//    if (zzKinect.available()) {
//      int [] usersDetected = zzKinect.getUsers();
//
//      if (usersDetected.length > 0) {		// si il y a un utilisateur
//        better.addEch(zzKinect.getSkeleton(usersDetected[0]));	// on ajoute les donnees du premier joueur detecte
//      }
//    }
//
...
//  vision();
//
//  if (zzKinect.getJoinedHands() != null)
//    test2 = true;
//
//  if (test1 && test2) {
